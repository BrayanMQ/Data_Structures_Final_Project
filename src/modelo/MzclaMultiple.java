...
class MzclaMultiple {
    ...
    static final int N = 6; //representa el número de archivos auxiliares (flujos)
    static final int N2 = N / 2; //  número de archivos de entrada,la mitad de N, también es el índice inicial de los flujos de salida (en Java, un array se indexa con base cero).
    static File f0;
    static File[] f = new File[N]; // representa los archivos auxiliares
